...
def build_eval_dl(eval_method, file_eval, mask_nei, data):
    eval_dl = {
    ...
    }[eval_method](file_eval, mask_nei, data)
    
    return eval_dl


def build_WholeGraph_OnePos_EvalDataLoader(file_eval, mask_nei, data):
...
def build_WholeGraph_MultiPos_EvalDataLoader(file_eval, mask_nei, data):
...
def build_SampledNeg_EvalDataLoader(file_eval, mask_nei, data):
