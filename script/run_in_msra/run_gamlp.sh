...
RESULTS_DIR="gamlp/best/[seed$SEED][$GAMLP_type][gcn_layer$num_gcn_layers][h$hidden][n1$n_layers_1][n2$n_layers_2][pre_process$pre_process][residual$residual][bns$bns]"
