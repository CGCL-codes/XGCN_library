PROJECT_ROOT='/home/songyu/songxiran/code/xgcn_neurips'
ALL_DATA_ROOT='/mnt/sevenT/songxiran/data/social_and_user_item'
...
python $PROJECT_ROOT'/'main/main.py $PROJECT_ROOT \
    ...
    --dnn_arch '[torch.nn.Linear(128, 1024), torch.nn.Tanh(), torch.nn.Linear(1024, 64)]' \
    --scale_net_arch '[torch.nn.Linear(128, 32), torch.nn.Tanh(), torch.nn.Linear(32, 1), torch.nn.Sigmoid()]' \
