from .ReIndexDict import ReIndexDict
...
def reindex_homogeneous_graph(filename, skiprows=0, delimiter=None):
...
def reindex_user_item_graph(filename, skiprows=0, delimiter=None):
