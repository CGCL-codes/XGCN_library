...
class ItemCF:
    ...
    def __init__(self, config):
        ...
        self.ui_indptr = io.load_pickle(osp.join(data_root, 'indptr.pkl'))
        self.ui_indices = io.load_pickle(osp.join(data_root, 'indices.pkl'))
        self.ui_src_indices = csr.get_src_indices(self.ui_indptr)
        ...
        if self.config['use_degree_norm']:
            ...
            undi_indptr, _ = csr.get_undirected(self.ui_indptr, self.ui_indices)
            del _
