...
DATASET='amazon-book' ## 'yelp2018' 'gowalla' 'amazon-book'  'taobao-1.6m'
...
RESULTS_DIR="xgcn_multi/[bpr][gcn_layers=$num_gcn_layers][1dnn][2layer-ffn][prop1][reg$L2_REG][T$T-K$K][load_best=$LOAD_BEST][USE_SNN=$USE_SNN][endure=$endure]"
RESULTS_ROOT=$ALL_RESULTS_ROOT'/gnn_'$DATASET'/'$RESULTS_DIR
